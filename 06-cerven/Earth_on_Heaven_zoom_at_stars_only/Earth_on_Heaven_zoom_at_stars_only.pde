 ...
 *  in this version the calculations of central point and scale are based only on stationary stars = it "cuts" off the gpx tracks if they go further then the stars. 
    It doesn't affect PD
...
void setup() {  
  ...
  frameRate(25);
  //You need to set the size of the sketch to the screen resolution of the second screen - depends on the projector
  size(800,600,OPENGL);
  ...
  // set resolution to width and height of the screen
